...
## How to add API Key for project usage
1. In the root folder create a file named <b>apiKeys.properties</b>
2. In this file, add your key like this <b>NASA_KEY="XXXXXXXXXXXXXXXXXX"</b>
